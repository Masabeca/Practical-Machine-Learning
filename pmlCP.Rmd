...
From the results, it appears that the RF (random forest) model has the best accuracy for testing dataset.

#Conclusion
Finally, I chosed the RF model to the testing dataset for submission result.
